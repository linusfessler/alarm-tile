...
public class WakeUpSettingsFragment extends Fragment {
    ...
    private FragmentWakeUpSettingsBinding binding;
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_wake_up_settings, container, false);
    ...
    public void onViewCreated(@NonNull final View view, @Nullable final Bundle savedInstanceState) {
        ...
        initAlarmTimePicker();
        initTimerTimePicker();
        initSnoozeTimePicker();
        initVolumeTimerTimePicker();
        initDismissTimerTimePicker();
    }

    private void initAlarmTimePicker() {
        ...
        binding.alarmTime.setOnClickListener(v -> alarmTimePickerDialog.show());
    }

    private void initTimerTimePicker() {
        final Context context = requireContext();
        ...
        binding.timerDuration.setOnClickListener(v -> timerTimePickerDialog.show());
    }

    private void initSnoozeTimePicker() {
        final Context context = requireContext();
        ...
        binding.snoozeDuration.setOnClickListener(v -> snoozeTimePickerDialog.show());
    }

    private void initVolumeTimerTimePicker() {
        final Context context = requireContext();
        ...
        binding.volumeTimerDuration.setOnClickListener(v -> volumeTimerTimePickerDialog.show());
    }

    private void initDismissTimerTimePicker() {
        final Context context = requireContext();
        ...
        binding.dismissTimerDuration.setOnClickListener(v -> dismissTimerTimePickerDialog.show());
    }
